...
def main(): 
    ...
    while not rospy.is_shutdown():
        ...
        if controller.invoked:
            ...
            controller.x_control = 300
            controller.y_control = 300
            controller.z_control = 0
            controller.yaw_control = 0

            controller.set_pwm()
            rospy.loginfo_throttle(15,"Control: x=%.2f, y=%.2f, yaw=%.2f",controller.x_pwm, controller.y_pwm, controller.yaw_pwm)
